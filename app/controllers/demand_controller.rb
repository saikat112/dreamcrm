...
skip_before_filter :verify_authenticity_token, only: [:dwc_parallel_outstanding_feed, :dwc_parallel_collection_feed, :parallel_outstanding_feed, :parallel_collection_feed]
