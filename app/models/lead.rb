...
def current_status
    status = ""
    if self.qualified_on != nil && self.interested_in_site_visit_on == nil && self.site_visited_on == nil
        status = "Qualified"
    elsif self.interested_in_site_visit_on != nil && self.site_visited_on == nil
        status = "ISV"
    elsif self.osv == true && self.qualified_on != nil && self.interested_in_site_visit_on != nil
        status = "OV"
    elsif self.site_visited_on != nil && self.booked_on == nil
        status = "Site Visited"
    elsif self.booked_on != nil
        status = "booked"
    else
        status = "In Followup"
    end
